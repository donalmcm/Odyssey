...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        donal.becomeMentor(java,noFridays, 4);
        ian.becomeMentor(git,fullAvailability, 2);
        ...
        Odyssey odyssey2 = new Odyssey(ian, donal, git);
        ...
        this.odysseyRepository.save(odyssey2);
