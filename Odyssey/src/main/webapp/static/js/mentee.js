...
function populateTopicDropdown(userId) {
    const topicURL = 'http://odyssey-aws.eu-west-1.elasticbeanstalk.com/api/employees/mentors/awaiting/excludingUser/' + userId;
...
function getMentorsByTopic(topic, userId) {
    ...
    let durationOptions = [];
    const menteeUrl = 'http://odyssey-aws.eu-west-1.elasticbeanstalk.com/api/employees/mentors/' + topic + '/excludingUser/' + userId;
...
function getAvailabilitiesByTopicAndDuration(duration, userId) {
    ...
    if (duration === "any") {
        ...
        const menteeUrl = 'http://odyssey-aws.eu-west-1.elasticbeanstalk.com/api/employees/mentors/' + topicChoice + '/duration/' + duration + '/excludingUser/' + userId;
        $.getJSON(menteeUrl, function (data) {
            $.each(data, function (key, entry) {
...
function getOdysseysByMentee(userId) {
    ...
    const menteeOdysseysURL = 'http://odyssey-aws.eu-west-1.elasticbeanstalk.com/api/odysseys/getOdysseysByMentee/' + userId;
