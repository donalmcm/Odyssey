...
const topicMentorUrl = 'http://odyssey-aws.eu-west-1.elasticbeanstalk.com/api/topics';
...
function getMentorAwaitingMentee(userId, userAwaitingMentee) {
    if (!userAwaitingMentee) {
        ...
        const employeeURL = 'http://odyssey-aws.eu-west-1.elasticbeanstalk.com/api/employees/' + userId;
...
function getOdysseysByMentor(userId, isAwaitingMentee) {
    ...
    const mentorOdysseysUrl = 'http://odyssey-aws.eu-west-1.elasticbeanstalk.com/api/odysseys/getOdysseysByMentor/' + userId;
