                ...
                <div class="modal-body" style="padding:40px 50px;">
                    <form role="form" method="post" id="odyssey-review-form">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="range" id="punctuality" name="punctuality" min="0" max="5" required>
                        </div>
                        <div class="form-group">
                            <label for="attendance">Attendance</label>
                            <input class="form-control" type="range" id="attendance" name="attendance" min="0" max="5" required>
                        </div>
                        <div class="form-group" id="course-material-section">
                            <label for="courseMaterial">Course Material</label>
                            <input class="form-control" type="range" id="courseMaterial" name="courseMaterial" min="0" max="5" required>
                        </div>
                        <div class="form-group" id="mentee-engagement-section">
                            <label for="menteeEngagement">Mentee Engagement</label>
                            <input class="form-control" type="range" id="menteeEngagement" name="menteeEngagement" min="0" max="5" required>
                        </div>
                        <div class="form-group">
                            <label for="rating">Rating</label>
                            <input class="form-control" type="range" id="rating" name="rating" min="0" max="5" required>
                        </div>
                        <div class="form-group">
